...
public final class TargetSelector {
  public BlockPos select(MinecraftClient c,AutoMinerConfig cfg,TargetHistory history,float baseYaw,MiningAreaSession area){
    ...
    for(BlockPos p:BlockPos.iterateOutwards(c.player.getBlockPos(),cfg.movement.searchDistance,cfg.movement.verticalUp+cfg.movement.verticalDown,cfg.movement.searchDistance)){
      ...
      if(area!=null&&!area.contains(p,cfg.movement.verticalUp,cfg.movement.verticalDown))continue;
