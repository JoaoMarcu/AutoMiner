...
- [Baixar mod AutoMiner 1.0.5](https://github.com/JoaoMarcu/AutoMiner/releases/latest/download/autominer-1.0.5.jar)
...
Também é possível baixar o [JAR do AutoMiner](https://github.com/JoaoMarcu/AutoMiner/releases/latest/download/autominer-1.0.5.jar) e colocá-lo na pasta `mods` de uma instalação Fabric 1.21.1.
...
A tag `v1.0.5` dispara `.github/workflows/release.yml` e publica automaticamente os artefatos após os builds passarem. A release será criada em [Releases](https://github.com/JoaoMarcu/AutoMiner/releases).
